...
type Step = "meter" | "amount" | "review" | "processing" | "guest-ecocash" | "delivering" | "success" | "error";
        ...
        {step === "delivering" && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: 520, textAlign: "center" }}>
            ...
            <div style={{ fontWeight: 700, marginTop: 24, fontSize: 15.5 }}>
              {deliveryTimedOut ? "Still processing" : "Fetching your token…"}
            </div>
            ...
            {deliveryTimedOut && (
              <Link href="/home" className="btn btn-primary btn-block mt-4" style={{ textDecoration: "none" }}>Done</Link>
            )}
          </div>
        )}
