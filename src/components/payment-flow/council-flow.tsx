...
import { EditableRow, GuestPaySection, ReviewRow } from "./flow-shared";
        ...
        {step === "amount" && (
          <>
            <div className="card card-pad row gap-2" style={{ marginBottom: 18 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: 700, fontSize: 14.5 }}>{account}</div>
                <div className="muted">{service.id_label}</div>
              </div>
            </div>

            <label className="field-label">Payment Amount (USD)</label>
            <input
              className="field"
              placeholder="$0.00"
              inputMode="decimal"
            ...
            <div className="muted mt-2" style={{ fontSize: 12 }}>
              How much do you want to pay towards this account? Charged in USD.
            </div>
