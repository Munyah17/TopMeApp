...
import { NAV, portalHref, type NavItem } from "@/components/admin/nav";
...
// NAV and portalHref live in @/components/admin/nav — shared with the
// customer AppShell, which renders this same portal nav for staff browsing
// the public site.
